...
exports.generateOperationResponse = exports.generateResponseOpenAI = void 0;
const traceable_1 = require("langsmith/traceable");
const messages_1 = require("@langchain/core/messages");
const config_1 = require("./config");
const operationTools_1 = require("./operationTools");
/**
 * Gera resposta usando OpenAI (reutiliza a função do planning.ts)
 */
exports.generateResponseOpenAI = (0, traceable_1.traceable)(function OpenAiChatCompleiton(messages_2) {
    ...
    name: "Generate Response OpenAI (Operation)",
    run_type: "llm",
    metadata: {
        provider: "OpenAI"
    }
 ...
 */
const selectAndExecuteTools = (0, traceable_1.traceable)(function selectAndExecuteTools(pergunta, startDate, endDate) {
 ...
 */
exports.generateOperationResponse = (0, traceable_1.traceable)(function generateOperationResponse(startDate, endDate, pergunta, onChunk) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log("[Operation Planning] Gerando resposta...");
            // Executa as ferramentas
            const toolResults = yield selectAndExecuteTools(pergunta, startDate, endDate);
...
${context}`;
            ...
            // Gera a resposta
            const response = yield (0, exports.generateResponseOpenAI)(messages, "advanced", onChunk);
