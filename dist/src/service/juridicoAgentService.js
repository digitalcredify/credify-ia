...
const juridicoAgentService = (pergunta, document, name, userId, sessionId, historyManager, onChunk, activeCnj) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        switch (routerDecision.routerName) {
            case 'web_agent':
                ...
                return yield (0, runJuridicoWebAgent_1.runJuridicoWebAgent)(pergunta, document, name, userId, sessionId, historyManager, onChunk, activeCnj);
            case 'pdf_agent':
