...
const juridicoAgentController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (config_1.ENABLE_STREAMING) {
            ...
            try {
                const response = yield (0, juridicoAgentService_1.juridicoAgentService)(pergunta, document, name, userId, finalSessionId, historyManager, chunk, activeCnj);
...
const juridicoIngestDetailedController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (config_1.ENABLE_STREAMING) {
            ...
            res.flushHeaders();
            const onChunk = (chunk) => {
                res.write(`data: ${JSON.stringify({ summaryChunk: chunk })}\n\n`);
            };
            try {
                const result = yield (0, ingest_juridico_detailed_data_1.ingestJuridicoDetailedData)(jsonData, document, name, sessionId, processId, onChunk);
