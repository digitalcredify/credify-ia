...
function createRangeFilter(startDate, endDate, startHour, endHour) {
    const filters = {
        must: [
...
exports.operationSpecificQueryTool = (0, traceable_1.traceable)(function operationSpecificQueryTool(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const startHour = (_c = input.filters) === null || _c === void 0 ? void 0 : _c.startHour;
            const endHour = (_d = input.filters) === null || _d === void 0 ? void 0 : _d.endHour;
