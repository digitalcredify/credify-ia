...
const juridicoAgentService = (pergunta, document, name, onChunk) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        switch (routerDecision.routerName) {
            case 'web_agent':
                ...
                return yield (0, runJuridicoWebAgent_1.runJuridicoWebAgent)(pergunta, document, name, onChunk);
            case 'pdf_agent':
            ...
            default:
                ...
                return yield (0, runJuridicoWebAgent_1.runJuridicoWebAgent)(pergunta, name, document, onChunk);
        }
    }
    catch (error) {
