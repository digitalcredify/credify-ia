...
const juridicoAgentService = (pergunta, document, name, userId, // ← NOVO
sessionId, // ← NOVO
historyManager, // ← NOVO
    ...
    try {
        ...
        switch (routerDecision.routerName) {
            case 'web_agent':
                ...
                return yield (0, runJuridicoWebAgent_1.runJuridicoWebAgent)(pergunta, document, name, userId, // ← NOVO
                sessionId, // ← NOVO
                historyManager, // ← NOVO
                onChunk);
            case 'pdf_agent':
            ...
            default:
                ...
                return yield (0, runJuridicoWebAgent_1.runJuridicoWebAgent)(pergunta, name, document, userId, // ← NOVO
                sessionId, // ← NOVO
                historyManager, // ← NOVO
                onChunk);
        }
